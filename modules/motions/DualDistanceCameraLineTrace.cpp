/**
 * @file   DualDistanceCameraLineTrace.cpp
...
DualDistanceCameraLineTrace::DualDistanceCameraLineTrace(
    Robot& _robot, double _targetDistance, double _targetSpeed, int _targetXCoordinate,
    const PidGain& _pidGain, const CameraServer::BoundingBoxDetectorRequest& _detectionRequestFirst,
    const CameraServer::BoundingBoxDetectorRequest& _detectionRequestSecond)
  : DualCameraPidTracking(_robot, _targetSpeed, _targetXCoordinate, _pidGain,
                          _detectionRequestFirst, _detectionRequestSecond),

...
//                                          int _postTargetAngle, double _basePower,
//                                          double _backTargetDistance, double
//                                          _forwardTargetDistance, double _backSpeed, double
//                                          _forwardSpeed, int _position)
...
//   // 撮影のための回頭をする
//   IMURotation preIMUR(robot, preTargetAngle, basePower, isClockwise, PidGain(0.036, 0.012,
//   0.03)); preIMUR.run();
...
//   // 黒線復帰のための回頭をする
//   IMURotation postIMUR(robot, postTargetAngle, basePower, !isClockwise,
//                        PidGain(0.036, 0.012, 0.03));
//   postIMUR.run();
// }
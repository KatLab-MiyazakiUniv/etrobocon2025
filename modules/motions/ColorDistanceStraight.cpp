// /**
//  * @file   ColorDistanceStraight.cpp
//  * @brief  目標距離まで直進するクラス
//  * @author nishijima515
//  */
...
// ColorDistanceStraight::ColorDistanceStraight(Robot& _robot, double _targetDistance, double
// _targetSpeed)
//   : Straight(_robot, _targetSpeed), targetDistance(_targetDistance)
// {
// }

// bool ColorDistanceStraight::isMetPreCondition()
// {
...
// void ColorDistanceStraight::prepare()
// {
//   // 呼び出し時の走行距離を取得する
...
// bool ColorDistanceStraight::isMetContinuationCondition()
// {
//   // 現在の走行距離を取得する

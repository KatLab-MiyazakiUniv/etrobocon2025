...
//    * @param _basePower 撮影前後の回頭のための基準パワー
...
//    */
//   MiniFigCameraAction(Robot& _robot, bool _isClockwise, int _preTargetAngle, int
//   _postTargetAngle,
//                       double _basePower, double _backTargetDistance, double
//                       _forwardTargetDistance, double _backSpeed, double _forwardSpeed, int
//                       _position);

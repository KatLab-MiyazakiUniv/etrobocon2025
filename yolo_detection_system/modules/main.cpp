...
int main(int argc, char* argv[])
{
  ...
  if(target == "background") {
    BackgroundDirectionDetector detector("/home/takahashi/etrobocon/etrobo/raspike-athrill-v850e2m/sdk/workspace/etrobocon2025/datafiles/models/11n_100epoch_&_640imgsz_background.onnx");
    detector.detect();
  } else {

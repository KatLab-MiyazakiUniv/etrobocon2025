...
MiniFigDirectionDetector::MiniFigDirectionDetector(const string& _modelPath)
...
void MiniFigDirectionDetector::detect(const Mat& frame, MiniFigDirectionResult& result)
{
